...
const day1 = new Day1();
console.log('##### Day1');
console.log('Part1', day1.part1());
console.log('Part2', day1.part2());

const day2 = new Day2();
console.log('\n##### Day2');
console.log('Part1', day2.part1());
console.log('Part2', day2.part2());

const day3 = new Day3();
console.log('\n##### Day3');
console.log('Part1', day3.part1());
console.log('Part2', day3.part2());

const day4 = new Day4();
console.log('\n##### Day4');
console.log('Part1', day4.part1());
console.log('Part2', day4.part2());

const day5 = new Day5();
console.log('\n##### Day5');
console.log('Part1', day5.part1());
console.log('Part2', day5.part2());

const day6 = new Day6();
console.log('\n##### Day6');
console.log('Part1', day6.part1());
console.log('Part2', day6.part2());

const day7 = new Day7();
console.log('\n##### Day7');
console.log('Part1', day7.part1());
console.log('Part2', day7.part2());

const day8 = new Day8();
console.log('\n##### Day8');
console.log('Part1', day8.part1());
console.log('Part2', day8.part2());

const day9 = new Day9();
day9.stepLength = 25;
console.log('\n##### Day9');
console.log('Part1', day9.part1());
console.log('Part2', day9.part2());
